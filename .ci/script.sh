...
then
  ...
  graalvm = graalvm-unknown-java11-19.3.0-dev
elif [ "$1" = "osx" ]
then
  ...
  graalvm = graalvm-unknown-java11-19.3.0-dev/Contents/Home
else
...
java -cp com.gluonhq.substrate/build/libs/com.gluonhq.substrate-0.0.1-SNAPSHOT.jar -Dimagecp=. -Dgraalvm=$graalvm -Dmainclass=HelloWorld com.gluonhq.substrate.SubstrateDispatcher